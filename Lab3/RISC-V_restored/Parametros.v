...
/* Operacoes da ULA FP */
	...
	FOPCVTSW    = 5'd10,
	FOPCVTWS    = 5'd11,
	FOPCVTSWU   = 5'd12,    //criar operação
   FOPCVTWUS   = 5'd13,    //criar operação
   FOPSGNJS    = 5'd14,    //criar operação		
   FOPSGNJN    = 5'd15,    //criar operação
   FOPSGNJX    = 5'd16,    //criar operação
   FOPMIN      = 5'd17,    //criar operação
   FOPMAX      = 5'd18,    //criar operação	
	FOPNULL		= 5'd31,
