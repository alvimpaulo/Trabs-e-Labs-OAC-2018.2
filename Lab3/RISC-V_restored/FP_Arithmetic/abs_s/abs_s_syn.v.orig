...
//altfp_abs DEVICE_FAMILY="Cyclone V" PIPELINE=0 WIDTH_EXP=8 WIDTH_MAN=23 data nan nan_in overflow overflow_in result underflow underflow_in zero zero_in
...
module  abs_s_altfp_abs
	...
	underflow_in,
	zero,
	zero_in) /* synthesis synthesis_clearbox=1 */;
	input   [31:0]  data;
	output   nan;
	input   nan_in;
	output   overflow;
...
module abs_s (
	...
	abs_s_altfp_abs	abs_s_altfp_abs_component (
				.data (data),
				.nan_in (nan_in),
