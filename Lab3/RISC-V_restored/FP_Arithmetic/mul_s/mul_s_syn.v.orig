...
//altfp_mult DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" EXCEPTION_HANDLING="NO" PIPELINE=5 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clock dataa datab nan overflow result underflow zero
...
//lpm_add_sub DEVICE_FAMILY="Cyclone V" LPM_WIDTH=10 cin dataa datab result
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END
...
//lpm_mult DEDICATED_MULTIPLIER_CIRCUITRY="YES" DEVICE_FAMILY="Cyclone V" LPM_PIPELINE=2 LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=24 LPM_WIDTHB=24 LPM_WIDTHP=48 LPM_WIDTHS=1 aclr clken clock dataa datab result
...
endmodule //mul_s_mult

//synthesis_resources = lut 55 reg 140 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  mul_s_altfp_mult
	( 
	clock,
	dataa,
	datab,
...
module mul_s (
	...
	mul_s_altfp_mult	mul_s_altfp_mult_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.nan (sub_wire0),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL mul_s.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL mul_s_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL mul_s_bb.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL mul_s.inc TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL mul_s.cmp TRUE TRUE
