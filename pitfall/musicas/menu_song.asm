...
menu_song(55,400,1,60,400) #Sol 1 oitava a menos
menu_song(72,1200,1,60,1200) # Dó
menu_song(64,1200,1,60,0) #Mi
menu_song (67,1200,1,60,1200)  #Sol
menu_song (65,400,1,60,400)  #Fá
menu_song(64,400,1,60,400) #Mi
menu_song(62,400,1,60,400) #Ré
menu_song (65,1200,1,60,0)  #Fá
menu_song(84,1200,1,60,1200) # Dó 1 oitava a mais
...
menu_song(62,1200,1,60,1200) #Ré
beq s0,zero,FIM
