...
//altfp_convert DEVICE_FAMILY="Cyclone V" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clock dataa result
...
//altbarrel_shift DEVICE_FAMILY="Cyclone V" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=32 WIDTHDIST=5 aclr clk_en clock data distance result
...
module  cvt_s_w_altbarrel_shift
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //cvt_s_w_altbarrel_shift
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  cvt_s_w_altpriority_encoder1234
	( 
	data,
	q,
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //cvt_s_w_altpriority_encoder1234

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  cvt_s_w_altpriority_encoder123
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	cvt_s_w_altpriority_encoder1234   altpriority_encoder15
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder15_q),
	.zero(wire_altpriority_encoder15_zero));
	cvt_s_w_altpriority_encoder1234   altpriority_encoder16
	( 
	.data(data[3:2]),
...
endmodule //cvt_s_w_altpriority_encoder123

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  cvt_s_w_altpriority_encoder12
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	cvt_s_w_altpriority_encoder123   altpriority_encoder13
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	cvt_s_w_altpriority_encoder123   altpriority_encoder14
	( 
	.data(data[7:4]),
...
endmodule //cvt_s_w_altpriority_encoder12

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  cvt_s_w_altpriority_encoder1
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	cvt_s_w_altpriority_encoder12   altpriority_encoder11
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	cvt_s_w_altpriority_encoder12   altpriority_encoder12
	( 
	.data(data[15:8]),
...
endmodule //cvt_s_w_altpriority_encoder1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  cvt_s_w_altpriority_encoder12345678
	( 
	data,
	...
	assign
		q = {data[1]};
endmodule //cvt_s_w_altpriority_encoder12345678

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  cvt_s_w_altpriority_encoder1234567
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [3:0]  data;
	...
	cvt_s_w_altpriority_encoder12345678   altpriority_encoder21
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder21_q));
	cvt_s_w_altpriority_encoder1234   altpriority_encoder22
	( 
	.data(data[3:2]),
...
endmodule //cvt_s_w_altpriority_encoder1234567

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  cvt_s_w_altpriority_encoder123456
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [7:0]  data;
	...
	cvt_s_w_altpriority_encoder1234567   altpriority_encoder19
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder19_q));
	cvt_s_w_altpriority_encoder123   altpriority_encoder20
	( 
	.data(data[7:4]),
...
endmodule //cvt_s_w_altpriority_encoder123456

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  cvt_s_w_altpriority_encoder12345
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [15:0]  data;
	...
	cvt_s_w_altpriority_encoder123456   altpriority_encoder17
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder17_q));
	cvt_s_w_altpriority_encoder12   altpriority_encoder18
	( 
	.data(data[15:8]),
...
endmodule //cvt_s_w_altpriority_encoder12345

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  cvt_s_w_altpriority_encoder
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [31:0]  data;
	...
	cvt_s_w_altpriority_encoder1   altpriority_encoder10
	( 
	.data(data[31:16]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	cvt_s_w_altpriority_encoder12345   altpriority_encoder9
	( 
	.data(data[15:0]),
...
endmodule //cvt_s_w_altpriority_encoder


//lpm_add_sub DEVICE_FAMILY="Cyclone V" LPM_DIRECTION="ADD" LPM_WIDTH=31 ONE_INPUT_IS_CONSTANT="YES" dataa datab result
...
//lpm_add_sub DEVICE_FAMILY="Cyclone V" LPM_DIRECTION="ADD" LPM_WIDTH=12 ONE_INPUT_IS_CONSTANT="YES" cout dataa datab result
//VERSION_BEGIN 18.1 cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END
...
module  cvt_s_w_altfp_convert
	...
	cvt_s_w_altbarrel_shift   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	cvt_s_w_altpriority_encoder   altpriority_encoder2
	( 
	.data(prio_mag_int_a),
...
endmodule //cvt_s_w_altfp_convert
//VALID FILE
...
module cvt_s_w (
	...
	cvt_s_w_altfp_convert	cvt_s_w_altfp_convert_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL cvt_s_w.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL cvt_s_w_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL cvt_s_w_bb.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL cvt_s_w.inc TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL cvt_s_w.cmp TRUE TRUE
